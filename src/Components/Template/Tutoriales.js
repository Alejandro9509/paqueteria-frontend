                                    ...
                                    <div className="widget-header">
                                        ...
                                        <ul className = {classes.ol}>
                                            <li className = {classes.li}>
                                                <a href={CATALOGOS}><i/> {name} 1 - CATALOGOS.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={TARIFARIO}><i/> {name} 2 - TARIFARIO.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={CONVENIOS}><i/>  {name} 3 - CONVENIOS.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={RECOLECCION}><i/> {name} 4 - RECOLECCION.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={EMBARQUE}><i/> {name} 5 - EMBARQUE.</a></li>
                                            <li className = {classes.li}>
                                                <a href={GUIAS}><i/> {name} 6 - GUIAS.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={INFORMES}><i/> {name} 7 - INFORMES.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={VIAJES}><i/> {name} 8 - VIAJES.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={ULTIMAMILLA}><i/> {name} 9 - ULTIMAMILLA.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={APPMOVIL}><i/>{name} 10 - APPMOVIL.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={ESCANER}><i/>{name} 11 - ESCANER.</a>
                                            </li>
                                            <li className = {classes.li}>
                                                <a href={CORTEDECAJA}><i/>{name} 12 - CORTEDECAJA.</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
