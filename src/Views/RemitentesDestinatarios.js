...
import {obtenerCodigoPostalId, obtenerCodigosPostalesPorEstadoMunicipio} from "../Util/Contexts/CodigoPostalContext";
...
function RemitenteDestinatario(props) {
    ...
    useEffect(value => {
        ...
        if ((props.componentePadre === "Recoleccion" || props.componentePadre === "Embarque") && props.dataPadreConsulta.data.m_nIdRecoleccion > 0){
            if (props.remitente){
        ...
        }else if (props.componentePadre === "Embarque" && props.dataPadreConsulta.data.m_nIdEmbarque > 0){
    ...
    const handleChangeAutocomplete = (input, newValue) => {
        ...
        if (input === "Nombre"){
            ...
            setState({
                ...
                codigoPostal: newValue.m_nIdCP != 0 ? {
                    ...
                    <div className="input">
                        <Autocomplete
                            onChange={(event, newValue) =>
                                handleChangeAutocomplete("Nombre", newValue)
                            }
                            value={state.nombre}
            ...
            <div className="col-md-6">
                ...
                { props.remitente &&
                    ...
                    <div className="input">
                        <Autocomplete
                            freeSolo
                            onChange={(event, newValue) => handleChangeAutocomplete("origen", newValue)}
                            value={state.origen}
                    ...
                    <div className="col-sm-12 col-md-12 unit">
                        <div className="input">
                            <Autocomplete
                                ...
                                freeSolo
                                onChange={(event, newValue) => handleChangeAutocomplete("zonaTarifa",newValue)}
                                id="zonaTarifa"
                                disableClearable
                                forcePopupIcon={false}
