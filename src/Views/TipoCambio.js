  ...
  function handleShowModificar(id) {
    ...
    axios.get(url, { headers }).then(respuesta => {
      ...
      setState({
        ...
        showPopUp: true,
        idTipoCambio: id,
        fecha: respuesta.data.m_dtFecha,
              ...
              (row, i) => {
                ...
                return (
                  <tr {...row.getRowProps()}>
                    <td>
                      <div>
                        <a href="#Agregar" role="tab" data-toggle="tab" onClick={() => (handleShowModificar(row.original.m_nIdTipoCambio))} className="btn btn-default btn-sm m-user-edit"><i className="zmdi zmdi-edit" /></a>
                        <a href="#" className="btn btn-default btn-sm m-user-delete" onClick={() => (handleEliminar(row.original.m_nIdTipoCambio))}><i className="zmdi zmdi-close" /></a>
                      </div>
                    </td>
                    {row.cells.map(cell => {
                      return (
