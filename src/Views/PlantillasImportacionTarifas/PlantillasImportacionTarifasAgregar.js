...
import {agregarPlantillaImportacionTarifas, modificarPlantillaImportacionTarifas} from "../../Util/Contexts/PlantillasTarifasContext";
import {toBase64} from "../../Util/GlobalFunctions";
import InfoRoundedIcon from "@mui/icons-material/InfoRounded";

export default function PlantillasImportacionTarifasAgregar(props){
    const grid = {
        IDENTIFICACION: 3,
        GENERALES: 2,
        SEGURO: 2,
    ...
    const handleOnSubmit = async () => {
        try {
            ...
            if (props.value === null){
                agregarPlantillaImportacionTarifas(params).then(respuesta => {
                ...
                modificarPlantillaImportacionTarifas(state.idPlantilla,params).then(respuesta => {
                    showSuccess(respuesta.data.message)
                    restartState()
                    props.onSuccessSave()
                }).catch(err => {
