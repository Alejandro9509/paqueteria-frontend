...
class DetalleParadas extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (this.props.tour.m_nIdUltimaMilla !== prevProps.tour.m_nIdUltimaMilla
            || this.props.tour.m_arrClsParadaUltimaMilla.reduce((a, b) => +a.m_nIdOperador + (b.m_nIdOperador)) !== prevProps.tour.m_arrClsParadaUltimaMilla.reduce((a, b) => +a.m_nIdOperador + (b.m_nIdOperador))
