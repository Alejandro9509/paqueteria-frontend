        ...
        return (
            <Grid container className={"j-form"}>
                ...
                <Grid item md={6}>
                    ...
                    <RadioGroup onChange={(e) => this.props.changeValue(e.target.name,e.target.value)}
                                aria-label="tipoBusqueda" name="tipoBusqueda" value={this.props.values.tipoBusqueda}>
                        <Grid container>
                            <Grid item>
                ...
                <Grid item md={6}>
                    <Typography variant={"h4"}>Unidades</Typography>
                        <Grid container>
                            <Grid item>
                                <Radio style={{margin:"0px -11px"}} type="checkbox"
                                       onChange={(e) => this.props.changeValue(e.target.name,e.target.checked)}
                                       name="unidades" checked={this.props.values.unidades} />
