...
import {obtenerUnidadesUltimaMilla} from "../../Util/Contexts/UnidadesContext";
                                    ...
                                    <TableCell align="left"><ProgressBarCubicaje
                                        ...
                                        <Tooltip title={u.ocupado?"En Ruta":""}>
                                            <TableCell align="left">
                                                {<Link style={{cursor: "pointer",color:u.ocupado?"gray":''}}
                                                       onClick={() => this.props.reasignarOperador(u)}>{!u.m_nIdOperador ? "Asignar" : u.m_sNombreOperador}
                                                </Link>}
                                            </TableCell>
                                        </Tooltip>
