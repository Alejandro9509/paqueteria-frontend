...
class Seguimiento extends Component {
  constructor(props) {
    ...
    this.handleClickOpenDialogoEvidencia =
      this.handleClickOpenDialogoEvidencia.bind(this);
    this.handleClickCloseDialogoEvidenciaRecoleccion =
      this.handleClickCloseDialogoEvidenciaRecoleccion.bind(this);
    this.handleClickCloseDialogoEvidenciaEntrega =
      this.handleClickCloseDialogoEvidenciaEntrega.bind(this);
  }
  ...
  buscarAction(e) {
    e.preventDefault();
    obtenerInformeFolioTipo(
      this.state.folioBusqueda,
      ...
      obtenerImagenEvidencia(data.m_nIdRecoleccion, 1).then((respuestaRec) => {
        obtenerImagenEvidencia(data.m_nIdGuia, 0).then((respuestaEmb) => {
          this.setState({
            imagenesEvidenciaRecoleccion: respuestaRec.data
              ? respuestaRec.data
              : [],
            imagenesEvidenciaEmbarque: respuestaEmb.data
              ? respuestaEmb.data
              : [],
            data: data,
          });
  ...
  render() {
    ...
    return (
      <div>
        {this.state.setOpenDialogEvidenciasRecoleccion &&
          this.state.imagenesEvidenciaRecoleccion && (
        ...
        {this.state.setOpenDialogEvidenciasEntrega &&
          this.state.imagenesEvidenciaEmbarque && (
            <DialogoEvidenciasUltimaMilla
                ...
                >
                  <Grid item md={6}>
                    ...
                    >
                      <Timeline
                        items={
                          this.state.data.bitacora
                            ? this.state.data.bitacora.map((b) => ({
                                ts: b.Fecha + "T" + b.Hora,
                                text: b.Descripcion,
                              }))
                            : []
                      ...
                      >
                        <Grid container spacing={3}>
                          ...
                          <Grid
                            ...
                            md={6}
                            style={{
                              borderRight: "dotted 2px rgb(249, 160, 62)",
                            }}
                          >
                            <Box
                              display="flex"
                            ...
                            >
                              ...
                              <Grid item md={12}>
                                Entregó:{" "}
                                {this.state.data.m_sReceptorRecoleccion}
                                <Button
                                  fullWidth
                                  variant="text"
                                  color="primary"
