            ...
            <Grid container direction="row"  >
                <Grid item md={6}>
                    <Grid container spacing={1}  >
                        <Grid item md={12}>
                            <Typography variant={"h3"} style={{fontWeight: "bold", alignItems: "center", width:"100%"}}>Remitente </Typography>
                        </Grid>
                        <Grid item md={6}>
                ...
                <Grid item md={6}>
                    <Grid container spacing={1}  >
                        <Grid item md={12}>
                            <Typography variant={"h3"}  style={{fontWeight: "bold", alignItems: "center", width:"100%"}}>Destinatario </Typography>
                        </Grid>
                        <Grid item md={6}>
