...
function Recoleccion() {
  ...
  const handleAceptar = (e) => {
    ...
    var params = {
      ...
      m_dFecha: state.fechaHoraCreacion,
      m_tHora: state.fechaHoraCreacion,
                            ...
                            <div className="col-sm-4 col-md-2-5 unit">
                              ...
                              <label className="input select">
                                <select
                                  ...
                                  id="tipoCobro"
                                >
                                  <option value="0">Tipo Cobro</option>
                  ...
                  <div className="widget-content">
                    <div className="row">
                      <div className="col-md-12">
                        <form className="j-forms">
                          <div className="form-content">
                            <div className="col-sm-4 col-md-2 unit">
                            ...
                            <div className="col-sm-4 col-md-2 unit">
                              ...
                              <div className="input">
                                <input
                                  ...
                                  className="form-control"
                                  type="text"
                                  placeholder={state.horaRecoleccion}
                                  id="horaRecoleccion"
                                />
                              </div>
                            </div>
                      ...
                      <div className="col-md-12">
                        <form className="j-forms">
                          <div className="form-content">
                            ...
                            <div className="col-sm-4 col-md-12 unit">
                              <label className="label">Entrega En</label>
                              <div className="input">
                                <input
                                  onChange={handleChange}
                                  className="form-control"
                      ...
                      <form className="j-forms">
                        <div className="form-content">
                          <div className="col-sm-12 col-md-12 unit">
                            ...
                            <div className="input">
                              <label className="icon-left" htmlFor="importar">
                        ...
                        <div className="form-footer" className="col-md-12">
                          <button
                            className="btn btn-default btn-block ex-noty"
                            data-layout="topCenter"
                            data-type="information"
                          >
                            Notificación
