...
<br/>
                      ...
                      <button
                        type="submit"
                        className="btn btn-primary primary-btn pull-left"
                      >
                        Aceptar
                      </button>
                      <button
                        ...
                        role="tab"
                        data-toggle="tab"
                        className="btn btn-secondary secondary-btn pull-left"
                      >
                        Cancelar
                      </button>
                    </div>
