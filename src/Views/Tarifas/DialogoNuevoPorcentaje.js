...
export default function DialogoNuevoRango(props) {
    ...
    const validarData = () => {
        ...
        if (parseInt(rango.idUnidadMedida) === UNIDADES_MEDIDA.PORCIENTO) {
        ...
        if (parseInt(rango.idUnidadMedida) === UNIDADES_MEDIDA.KILOGRAMOS || parseInt(rango.idUnidadMedida) === UNIDADES_MEDIDA.TONELADAS || parseInt(rango.idUnidadMedida) === UNIDADES_MEDIDA.PIEZAS){
