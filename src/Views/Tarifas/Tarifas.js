...
class Tarifas extends Component {
    ...
    handleAceptar(data) {
        var params = {
            ...
            m_arrArConceptos: data.conceptosAdicionales.map(c => ({ m_nIdConceptosFacturacion: c.concepto.m_nIdConceptosFacturacion, m_cImporte: c.importe, m_nIdImpuestoTraslada: c.traslada, m_nIdImpuestoRetiene: c.retiene, m_cImporteRetiene: c.importeRet, m_cImporteIva: c.importeIVA, m_nIdTipoCalculo: c.tipoCalculo, m_xnRangoMinimo: c.rangoMinimo, m_xnRangoMaximo: c.rangoMaximo })),
