...
function EstatusRecoleccion() {

    const [data, setData] = React.useState([])

    const [state, setState] = React.useState({
        idEstatusRecoleccion: 0,
        DerechoBorrar: 81,
    ...
    return (
        <div >
            ...
            <header className="topbar clearfix">
                <Cabecera titulo="Estatus Recoleccion" >
                    <div className="page-header">
                        <ul className="list-page-breadcrumb">
                            ...
                            <li className="active-page">Estatus Recoleccion</li>
                        </ul>
                    </div>
                </Cabecera>
            </header>
...
export default EstatusRecoleccion;
