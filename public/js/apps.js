...
//    **----------
        var WebFontConfig = {
            google: {
                families: [
                    'Calibri:400,300,400italic,500:latin'
                ]
            }
        };
        (function() {
...
$(".spark-pie-chart").each(function(){
    ...
    if ($.noty) {
        var n_dom = [];
            ...
            n_dom[4] = '<div class="activity-item"> <i class="zmdi zmdi-truck"></i> <div class="activity"> This is a example notification <a href="#">Here</a> <span>14 minutes ago</span> </div> </div>',
            n_dom[5] = '<div class="activity-item"> <i class="zmdi zmdi-favorite-outline"></i> <div class="activity"> This is a example notification<a href="#">Here</a> <span>14 minutes ago</span> </div> </div>';
...
//            nGen('information', n_dom[1], 'topRight');
//            nGen('information', n_dom[2], 'topRight');
//            nGen('information', n_dom[3], 'topRight');
//            nGen('information', n_dom[4], 'topRight');
//        }
